# Website AI Assistant Model Context Protocol (MCP) Server
...
This is a MCP Server for the assistant. It provides a tool for generating response based on visitor's input.
...
Read more [**here**](https://github.com/VeritasSoftware/WebsiteAIAssistant/blob/master/Docs/README_MCPServer.md)